...
public class BlockOre extends Block
{
        			...
        			(this == Blocks.emerald_ore ? Items.emerald : 
        				(this == Blocks.quartz_ore ? Items.quartz : 
        					...
        					(this == Blocks.opale_ore ? Items.opale
        							: (this == Blocks.hydralite_ore ? Items.hydralite
        									: (this == Blocks.boxyte_ore ? Items.boxyte
        											: (this == Blocks.phenix_ore ? Items.phenix
        													:
        												
        													(this == Blocks.xp_ore ? null :
    ...
    public void dropBlockAsItemWithChance(World p_149690_1_, int p_149690_2_, int p_149690_3_, int p_149690_4_, int p_149690_5_, float p_149690_6_, int p_149690_7_)
    {
        ...
        if (this.getItemDropped(p_149690_5_, p_149690_1_.rand, p_149690_7_) != Item.getItemFromBlock(this))
        {
			...
			var8 = MathHelper.getRandomIntegerInRange(p_149690_1_.rand, 3, 7);
		} else if (this == Blocks.hydralite_ore) {
			var8 = MathHelper.getRandomIntegerInRange(p_149690_1_.rand, 3, 7);
		} else if (this == Blocks.boxyte_ore) {
			var8 = MathHelper.getRandomIntegerInRange(p_149690_1_.rand, 3, 7);
		} else if (this == Blocks.phenix_ore) {
			var8 = MathHelper.getRandomIntegerInRange(p_149690_1_.rand, 3, 7);
		} else if (this == Blocks.xp_ore) {
			var8 = MathHelper.getRandomIntegerInRange(p_149690_1_.rand, 60, 100);
		}
