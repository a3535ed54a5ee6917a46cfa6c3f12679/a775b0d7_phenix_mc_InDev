...
public class Block
{
    ...
    public static void registerBlocks()
    {
        ...
        blockRegistry.addObject(49, "obsidian", (new BlockObsidian()).setHardness(50.0F).setResistance(10.0F).setStepSound(soundTypePiston).setBlockName("obsidian").setBlockTextureName("obsidian"));
         ...
         * Opale
         */
        blockRegistry.addObject(200, "opale_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("opale_ore").setBlockTextureName("opale_ore"));
        blockRegistry.addObject(201, "opale_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("opale_block").setBlockTextureName("opale_block"));
        
        /**
         * Hydralite
         */
        blockRegistry.addObject(202, "hydralite_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("hydralite_ore").setBlockTextureName("hydralite_ore"));
        blockRegistry.addObject(203, "hydralite_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("hydralite_block").setBlockTextureName("hydralite_block"));
        
        /**
         * Boxyte
         */
        blockRegistry.addObject(204, "boxyte_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("boxyte_ore").setBlockTextureName("boxyte_ore"));
        blockRegistry.addObject(205, "boxyte_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("boxyte_block").setBlockTextureName("boxyte_block"));
        
        /**
         * Phenix
         */
        blockRegistry.addObject(206, "phenix_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setLightLevel(5.0F).setStepSound(soundTypePiston).setBlockName("phenix_ore").setBlockTextureName("phenix_ore"));
        blockRegistry.addObject(207, "phenix_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("phenix_block").setBlockTextureName("phenix_block"));
        
        /**
         * Legendaire
         */
        blockRegistry.addObject(208, "legendary_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("legendary_ore").setBlockTextureName("legendary_ore"));
        blockRegistry.addObject(209, "legendary_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("legendary_block").setBlockTextureName("legendary_block"));
       
        
        /**
         * Autres
         */
        blockRegistry.addObject(210, "xp_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("xp_ore").setBlockTextureName("xp_ore"));
        
        blockRegistry.addObject(211, "renforced_obsidian", (new BlockRenforcedObsidian()).setHardness(50.0F).setResistance(2000.0F).setStepSound(soundTypePiston).setBlockName("renforced_obsidian").setBlockTextureName("renforced_obsidian"));
        blockRegistry.addObject(212, "renforced_glass", (new BlockRenforcedGlass(Material.glass, false)).setHardness(0.3F).setResistance(2000.0F).setStepSound(soundTypeGlass).setBlockName("renforced_glass").setBlockTextureName("renforced_glass"));
        /**
         *  Ash
         */
        blockRegistry.addObject(213, "ash_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("ash_ore").setBlockTextureName("ash_ore"));
/**
 *  RandomOre
 */
        blockRegistry.addObject(214, "random_ore", (new BlockRandomOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("random_ore").setBlockTextureName("random_ore"));
       
/**
 *  Mateorite        
 */
        blockRegistry.addObject(2000, "meteorite", (new BlockObsidian()).setHardness(50.0F).setResistance(10.0F).setStepSound(soundTypePiston).setBlockName("meteorite").setBlockTextureName("meteorite"));
        blockRegistry.addObject(2001, "meteorite_rafine", (new BlockObsidian()).setHardness(50.0F).setResistance(10.0F).setStepSound(soundTypePiston).setBlockName("meteorite_rafine").setBlockTextureName("meteorite_rafine"));
