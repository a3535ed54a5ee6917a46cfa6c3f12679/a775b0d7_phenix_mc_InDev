...
public class Items
{
     ...
     * Hydralite
     */
    public static final Item hydralite = (Item)Item.itemRegistry.getObject("hydralite");
    public static final ItemArmor hydralite_helmet = (ItemArmor)Item.itemRegistry.getObject("hydralite_helmet");
    public static final ItemArmor hydralite_chestplate = (ItemArmor)Item.itemRegistry.getObject("hydralite_chestplate");
    public static final ItemArmor hydralite_leggings = (ItemArmor)Item.itemRegistry.getObject("hydralite_leggings");
    public static final ItemArmor hydralite_boots = (ItemArmor)Item.itemRegistry.getObject("hydralite_boots");
    public static final Item hydralite_sword = (Item)Item.itemRegistry.getObject("hydralite_sword");
    public static final Item hydralite_shovel = (Item)Item.itemRegistry.getObject("hydralite_shovel");
    public static final Item hydralite_pickaxe = (Item)Item.itemRegistry.getObject("hydralite_pickaxe");
    public static final Item hydralite_axe = (Item)Item.itemRegistry.getObject("hydralite_axe");
    public static final Item hydralite_hoe = (Item)Item.itemRegistry.getObject("hydralite_hoe");
    
    /**
     * Boxyte
     */
    public static final Item boxyte = (Item)Item.itemRegistry.getObject("boxyte");
    public static final ItemArmor boxyte_helmet = (ItemArmor)Item.itemRegistry.getObject("boxyte_helmet");
    public static final ItemArmor boxyte_chestplate = (ItemArmor)Item.itemRegistry.getObject("boxyte_chestplate");
    public static final ItemArmor boxyte_leggings = (ItemArmor)Item.itemRegistry.getObject("boxyte_leggings");
    public static final ItemArmor boxyte_boots = (ItemArmor)Item.itemRegistry.getObject("boxyte_boots");
    public static final Item boxyte_sword = (Item)Item.itemRegistry.getObject("boxyte_sword");
    public static final Item boxyte_shovel = (Item)Item.itemRegistry.getObject("boxyte_shovel");
    public static final Item boxyte_pickaxe = (Item)Item.itemRegistry.getObject("boxyte_pickaxe");
    public static final Item boxyte_axe = (Item)Item.itemRegistry.getObject("boxyte_axe");
    public static final Item boxyte_hoe = (Item)Item.itemRegistry.getObject("boxyte_hoe");
    
    /**
     * Phenix
     */
    public static final Item phenix = (Item)Item.itemRegistry.getObject("phenix");
    public static final ItemArmor phenix_helmet = (ItemArmor)Item.itemRegistry.getObject("phenix_helmet");
    public static final ItemArmor phenix_chestplate = (ItemArmor)Item.itemRegistry.getObject("phenix_chestplate");
    public static final ItemArmor phenix_leggings = (ItemArmor)Item.itemRegistry.getObject("phenix_leggings");
    public static final ItemArmor phenix_boots = (ItemArmor)Item.itemRegistry.getObject("phenix_boots");
    public static final Item phenix_sword = (Item)Item.itemRegistry.getObject("phenix_sword");
    public static final Item phenix_shovel = (Item)Item.itemRegistry.getObject("phenix_shovel");
    public static final Item phenix_pickaxe = (Item)Item.itemRegistry.getObject("phenix_pickaxe");
    public static final Item phenix_axe = (Item)Item.itemRegistry.getObject("phenix_axe");
    public static final Item phenix_hoe = (Item)Item.itemRegistry.getObject("phenix_hoe");
    
    /**
     * Legendaire
     */
    public static final Item legendary = (Item)Item.itemRegistry.getObject("legendary");
    public static final Item legendary_refined = (Item)Item.itemRegistry.getObject("legendary_refined");
    public static final ItemArmor legendary_helmet = (ItemArmor)Item.itemRegistry.getObject("legendary_helmet");
    public static final ItemArmor legendary_chestplate = (ItemArmor)Item.itemRegistry.getObject("legendary_chestplate");
    public static final ItemArmor legendary_leggings = (ItemArmor)Item.itemRegistry.getObject("legendary_leggings");
    public static final ItemArmor legendary_boots = (ItemArmor)Item.itemRegistry.getObject("legendary_boots");
    public static final Item legendary_sword = (Item)Item.itemRegistry.getObject("legendary_sword");
    public static final Item legendary_shovel = (Item)Item.itemRegistry.getObject("legendary_shovel");
    public static final Item legendary_pickaxe = (Item)Item.itemRegistry.getObject("legendary_pickaxe");
    public static final Item legendary_axe = (Item)Item.itemRegistry.getObject("legendary_axe");
    public static final Item legendary_hoe = (Item)Item.itemRegistry.getObject("legendary_hoe");
    
    /**
     * Arcs
     */
    public static final ItemBow opale_bow = (ItemBow)Item.itemRegistry.getObject("opale_bow");
    public static final ItemBow hydralite_bow = (ItemBow)Item.itemRegistry.getObject("hydralite_bow");
    public static final ItemBow boxyte_bow = (ItemBow)Item.itemRegistry.getObject("boxyte_bow");
    public static final ItemBow phenix_bow = (ItemBow)Item.itemRegistry.getObject("phenix_bow");
    public static final ItemBow legendary_bow = (ItemBow)Item.itemRegistry.getObject("legendary_bow");
    
    /**
     * Autres
     */
    public static final Item spawner_pickaxe = (Item)Item.itemRegistry.getObject("spawner_pickaxe");
    public static final Item obsidian_pickaxe = (Item)Item.itemRegistry.getObject("obsidian_pickaxe");
    public static final Item hamburger = (Item)Item.itemRegistry.getObject("hamburger");
    public static final Item phenix_stick = (Item)Item.itemRegistry.getObject("phenix_stick");
    public static final Item diamond_string = (Item)Item.itemRegistry.getObject("diamond_string");
    
    public static final Item opale_key = (Item)Item.itemRegistry.getObject("opale_key");
    public static final Item hydralite_key = (Item)Item.itemRegistry.getObject("hydralite_key");
    public static final Item boxyte_key = (Item)Item.itemRegistry.getObject("boxyte_key");
    public static final Item phenix_key = (Item)Item.itemRegistry.getObject("phenix_key");
    
    public static final Item cendres = (Item)Item.itemRegistry.getObject("cendres");
    
    public static final Item ash = (Item)Item.itemRegistry.getObject("ash");
    
    public static final Item meteorite = (Item)Item.itemRegistry.getObject("meteorite");
    public static final Item meteorite_rafine = (Item)Item.itemRegistry.getObject("meteorite_rafine");
