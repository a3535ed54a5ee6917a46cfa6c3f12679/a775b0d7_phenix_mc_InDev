...
public class Blocks
{
    ...
    * Hydralite
    */
    public static final Block hydralite_ore = (Block)Block.blockRegistry.getObject("hydralite_ore");
    public static final Block hydralite_block = (Block)Block.blockRegistry.getObject("hydralite_block");
    
   /**
    * Boxyte
    */
    public static final Block boxyte_ore = (Block)Block.blockRegistry.getObject("boxyte_ore");
    public static final Block boxyte_block = (Block)Block.blockRegistry.getObject("boxyte_block");
    
   /**
    * Phenix
    */
    public static final Block phenix_ore = (Block)Block.blockRegistry.getObject("phenix_ore");
    public static final Block phenix_block = (Block)Block.blockRegistry.getObject("phenix_block");
    
   /**
    * Legendaire
    */
    public static final Block legendary_ore = (Block)Block.blockRegistry.getObject("legendary_ore");
    public static final Block legendary_block = (Block)Block.blockRegistry.getObject("legendary_block");
    
    /**
     * 
     */
    public static final Block ash_ore = (Block)Block.blockRegistry.getObject("ash_ore");
    
   /**
    * Autres
    */
    public static final Block xp_ore = (Block)Block.blockRegistry.getObject("xp_ore");
    public static final Block random_ore = (Block)Block.blockRegistry.getObject("random_ore");
    public static final Block renforced_obsidian = (Block)Block.blockRegistry.getObject("renforced_obsidian");
    ...
    public static final Block meteorite_rafine = (Block)Block.blockRegistry.getObject("meteorite_rafine");
