...
public class BiomeDecorator
{
     ...
     * Opale
     */
    protected WorldGenerator opaleGen;
    
    /**
     * Hydralite
     */
    protected WorldGenerator hydraliteGen;
    
    /**
     * Boxyte
     */
    protected WorldGenerator boxyteGen;
    
    /**
     * Phenix
     */
    protected WorldGenerator phenixGen;
    
    /**
     * Legendaire
     */
    protected WorldGenerator legendaryGen;
    
    /**
     * Autres
     */
    protected WorldGenerator xpGen;
    
    private static final String __OBFID = "CL_00000164";

    public BiomeDecorator()
    {
    	this.opaleGen = new WorldGenMinable(Blocks.opale_ore, 7);
    	this.hydraliteGen = new WorldGenMinable(Blocks.hydralite_ore, 6);
    	this.boxyteGen = new WorldGenMinable(Blocks.boxyte_ore, 6);
    	this.phenixGen = new WorldGenMinable(Blocks.phenix_ore, 4);
    	this.legendaryGen = new WorldGenMinable(Blocks.legendary_ore, 3);
    	this.xpGen = new WorldGenMinable(Blocks.xp_ore, 10);
	...
	protected void generateOres() {
		this.genStandardOre1(1, this.opaleGen, 0, 32);
		this.genStandardOre1(1, this.hydraliteGen, 0, 24);
		this.genStandardOre1(1, this.boxyteGen, 0, 16);
		this.genStandardOre1(1, this.phenixGen, 0, 11);
		this.genStandardOre1(1, this.legendaryGen, 0, 9);
		this.genStandardOre1(20, this.xpGen, 0, 128);
