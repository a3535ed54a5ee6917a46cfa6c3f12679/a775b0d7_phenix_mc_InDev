...
public class RenderBlocks
{
    ...
    public boolean renderBlockStainedGlassPane(Block block, int x, int y, int z)
    {
        ...
        if (Config.isConnectedTextures() && this.overrideBlockTexture == null)
        {
            ...
            IIcon iz = ConnectedTextures.getConnectedTexture(this.blockAccess, block, x, y, z, 2, iconGlass1);
    ...
    public boolean renderBlockPane(BlockPane p_147767_1_, int p_147767_2_, int p_147767_3_, int p_147767_4_)
    {
        ...
        if (EntityRenderer.anaglyphEnable)
        {
            ...
            float cp = (var8 * 30.0F + var10 * 70.0F) / 100.0F;
            var8 = var64;
            var9 = var63;
            var10 = cp;
        }
        ...
        {
            int kr = this.blockAccess.getBlockMetadata(p_147767_2_, p_147767_3_, p_147767_4_);
            var631 = this.getBlockIconFromSideAndMetadata(p_147767_1_, 0, kr);
            var641 = p_147767_1_.func_150097_e();

            if (Config.isConnectedTextures())
            {
                cp1 = ConnectedTextures.getConnectedProperties(this.blockAccess, p_147767_1_, p_147767_2_, p_147767_3_, p_147767_4_, -1, var631);
            }
        }
        ...
        if (cp1 != null)
        {
            Block blockIdXp = this.blockAccess.getBlock(p_147767_2_ + 1, p_147767_3_, p_147767_4_);
            Block var15 = this.blockAccess.getBlock(p_147767_2_ - 1, p_147767_3_, p_147767_4_);
            Block blockIdYp = this.blockAccess.getBlock(p_147767_2_, p_147767_3_ + 1, p_147767_4_);
            Block var17 = this.blockAccess.getBlock(p_147767_2_, p_147767_3_ - 1, p_147767_4_);
            Block blockIdZp = this.blockAccess.getBlock(p_147767_2_, p_147767_3_, p_147767_4_ + 1);
            Block var19 = this.blockAccess.getBlock(p_147767_2_, p_147767_3_, p_147767_4_ - 1);
            boolean linkXp = blockIdXp == p_147767_1_;
            boolean var21 = var15 == p_147767_1_;
            boolean linkYp = blockIdYp == p_147767_1_;
            boolean dr = var17 == p_147767_1_;
            boolean linkZp = blockIdZp == p_147767_1_;
            boolean d1r = var19 == p_147767_1_;
            int var64i = ConnectedTextures.getPaneTextureIndex(linkXp, var21, linkYp, dr);
            int d2r = ConnectedTextures.getReversePaneTextureIndex(var64i);
            int kzi = ConnectedTextures.getPaneTextureIndex(linkZp, d1r, linkYp, dr);
            int d3r = ConnectedTextures.getReversePaneTextureIndex(kzi);
            var631 = ConnectedTextures.getCtmTexture(cp1, var64i, var631);
            kr1 = ConnectedTextures.getCtmTexture(cp1, d2r, kr1);
            kz = ConnectedTextures.getCtmTexture(cp1, kzi, kz);
            kzr = ConnectedTextures.getCtmTexture(cp1, d3r, kzr);
        }

        double var65 = (double)var631.getMinU();
        double var151 = (double)var631.getInterpolatedU(8.0D);
        double var171 = (double)var631.getMaxU();
        double var191 = (double)var631.getMinV();
        double var211 = (double)var631.getMaxV();
        double dr1 = (double)kr1.getMinU();
        double d1r1 = (double)kr1.getInterpolatedU(8.0D);
        double d2r1 = (double)kr1.getMaxU();
        double d3r1 = (double)kr1.getMinV();
        ...
        if ((!var55 || !var56) && (var55 || var56 || var53 || var54))
        {
            if (var55 && !var56)
            {
                var6.addVertexWithUV(var33, (double)(p_147767_3_ + 1), var41, var65, var191);
                var6.addVertexWithUV(var33, (double)(p_147767_3_ + 0), var41, var65, var211);
                var6.addVertexWithUV(var35, (double)(p_147767_3_ + 0), var41, var151, var211);
                var6.addVertexWithUV(var35, (double)(p_147767_3_ + 1), var41, var151, var191);
                var6.addVertexWithUV(var35, (double)(p_147767_3_ + 1), var41, d1r1, d3r1);
                var6.addVertexWithUV(var35, (double)(p_147767_3_ + 0), var41, d1r1, d4r);
                var6.addVertexWithUV(var33, (double)(p_147767_3_ + 0), var41, d2r1, d4r);
                var6.addVertexWithUV(var33, (double)(p_147767_3_ + 1), var41, d2r1, d3r1);
            ...
            else if (!var55 && var56)
            {
                var6.addVertexWithUV(var35, (double)(p_147767_3_ + 1), var41, var151, var191);
                var6.addVertexWithUV(var35, (double)(p_147767_3_ + 0), var41, var151, var211);
                var6.addVertexWithUV(var37, (double)(p_147767_3_ + 0), var41, var171, var211);
                var6.addVertexWithUV(var37, (double)(p_147767_3_ + 1), var41, var171, var191);
                var6.addVertexWithUV(var37, (double)(p_147767_3_ + 1), var41, dr1, d3r1);
                var6.addVertexWithUV(var37, (double)(p_147767_3_ + 0), var41, dr1, d4r);
                var6.addVertexWithUV(var35, (double)(p_147767_3_ + 0), var41, d1r1, d4r);
                var6.addVertexWithUV(var35, (double)(p_147767_3_ + 1), var41, d1r1, d3r1);
