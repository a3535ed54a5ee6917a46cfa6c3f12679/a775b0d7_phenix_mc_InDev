...
public class RenderItem extends Render
{
    ...
    public void renderArmorHUD(FontRenderer p_94148_1_, TextureManager p_94148_2_, ItemStack p_94148_3_, int p_94148_4_, int p_94148_5_, String p_94148_6_)
    {
        if (p_94148_3_ != null)
        {
        	if(p_94148_3_.getItem() == Items.skull)
        	{
        		if (p_94148_3_.hasTagCompound())
                {
	        		   NBTTagCompound var8 = p_94148_3_.getTagCompound();
	        		   GameProfile var7 = null;

	                  GL11.glDisable(GL11.GL_LIGHTING);
	                  GL11.glDisable(GL11.GL_DEPTH_TEST);
	                  GL11.glDisable(GL11.GL_BLEND);
	                  p_94148_1_.drawStringWithShadow(var7.getName(), p_94148_4_, p_94148_5_, 16777215); 
	                  GL11.glEnable(GL11.GL_LIGHTING);
	                  GL11.glEnable(GL11.GL_DEPTH_TEST);
                }
        	}
        	...
        	{
                int var12 = 0;
                if(p_94148_3_.getMaxDamage() != 0)
                	var12 = 100 - (100 * p_94148_3_.getItemDamage() / p_94148_3_.getMaxDamage());
				...
				String affichage = "";
				if(var12 != 0)
					 affichage = Integer.toString(var12) + "%";
                GL11.glDisable(GL11.GL_LIGHTING);
                GL11.glDisable(GL11.GL_DEPTH_TEST);
                GL11.glDisable(GL11.GL_BLEND);
                p_94148_1_.drawStringWithShadow(affichage, p_94148_4_, p_94148_5_, couleur); 
                GL11.glColor4f(1.0F,1.0F,1.0F,1.0F);
                GL11.glEnable(GL11.GL_LIGHTING);
                GL11.glEnable(GL11.GL_DEPTH_TEST);
        	}
