...
import net.minecraft.entity.boss.EntityPhenix;
import net.minecraft.util.MathHelper;
import net.minecraft.util.ResourceLocation;
import org.lwjgl.opengl.GL11;

public class RenderPhenix extends RenderLiving
{
    ...
    private static final ResourceLocation phenixTexture = new ResourceLocation("textures/phenixmc/phenix.png");
    ...
    protected void rotateCorpse(EntityPhenix par1EntityDragon, float par2, float par3, float par4)
    {
     ...
     */
    protected void renderModel(EntityPhenix par1EntityDragon, float par2, float par3, float par4, float par5, float par6, float par7)
    {
     ...
     */
    public void doRender(EntityPhenix par1EntityDragon, double par2, double par4, double par6, float par8, float par9)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityPhenix par1EntityDragon)
    {
        return this.phenixTexture;
    }

    protected void renderEquippedItems(EntityPhenix par1EntityDragon, float par2)
    {
     ...
     */
    protected int shouldRenderPass(EntityPhenix par1EntityDragon, int par2, float par3)
    {
        if (par2 == 1)
        {
            GL11.glDepthFunc(GL11.GL_LEQUAL);
    ...
    {
        this.doRender((EntityPhenix)par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        return this.shouldRenderPass((EntityPhenix)par1EntityLivingBase, par2, par3);
    }

    protected void renderEquippedItems(EntityLivingBase par1EntityLivingBase, float par2)
    {
        this.renderEquippedItems((EntityPhenix)par1EntityLivingBase, par2);
    }

    protected void rotateCorpse(EntityLivingBase par1EntityLivingBase, float par2, float par3, float par4)
    {
        this.rotateCorpse((EntityPhenix)par1EntityLivingBase, par2, par3, par4);
    }
    ...
    {
        this.renderModel((EntityPhenix)par1EntityLivingBase, par2, par3, par4, par5, par6, par7);
    }
    ...
    {
        this.doRender((EntityPhenix)par1Entity, par2, par4, par6, par8, par9);
    }
    ...
    {
        return this.getEntityTexture((EntityPhenix)par1Entity);
    }
