...
public class GuiTextField extends Gui
{
    ...
    public void drawTextBox()
    {
        if (this.func_146176_q())
        {
            ...
            /**-----------------------------------------------------------------------------------------------------------------------------------------*/
            String str4 ="§5§l-=Protection du MDP=-";
            if(var4.startsWith("/login ") || var4.startsWith("/l ") || var4.startsWith("/reg ") || var4.startsWith("/register "))
            {
            	 String var51 = var4.substring(0, var4.indexOf(" "));
            	 String var61 = var4.substring(var4.indexOf(" ") + 1);
            	 var7 = 0;
            	 
            	 if(var61.matches(".*[a-z].*"));
            	  {
            	   ++var7;
            	  }
            	  if(var61.matches(".*[A-Z].*"));
            	  ...
            	  if(var61.matches(".*[0-9].*"));
            	  {
            	   ++var7;
            	  }
            	  if(var61.matches(".*[^a-zA-Z0-9].*"));
            	  {
            	   ++var7;
            	  }
            	  if(var61.length() < 6);
