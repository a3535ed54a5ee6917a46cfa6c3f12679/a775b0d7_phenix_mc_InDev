...
public class Main
{
    ...
    public static void main(String[] par0ArrayOfStr)
    {
        ...
        ArgumentAcceptingOptionSpec var11 = var1.accepts("username").withRequiredArg().defaultsTo("Michel"/* + Minecraft.getSystemTime() % 1000L, new String[0]*/);
