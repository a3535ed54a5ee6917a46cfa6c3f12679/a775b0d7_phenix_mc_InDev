...
public class EntityList
{
    ...
    private static void addMapping(Class par0Class, String par1Str, int par2)
    {
        ...
        {
            throw new IllegalArgumentException("ID est déjà enregistrer: " + par1Str);
        }
        else if (IDtoClassMapping.containsKey(Integer.valueOf(par2)))
        {
            throw new IllegalArgumentException("ID est déjà enregistrer: " + par2);
        }
        else
        {
    ...
    static
    {
         ...
         *  Phenix
         */
        addMapping(EntityPhenix.class, "Phenix", 121, 12623485, 13545366);
    }
