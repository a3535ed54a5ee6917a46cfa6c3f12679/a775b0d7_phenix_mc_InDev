...
public abstract class EntityLivingBase extends Entity
{
    ...
    protected void fall(float par1)
    {
        ...
        MathHelper.ceiling_float_int(par1 - 3.0F - var3);

        PotionEffect var21 = this.getActivePotionEffect(Potion.featherfalling);
        float var31 = var21 != null ? (float)(var21.getAmplifier() + 256) : 0.0F;
        int var4 = MathHelper.ceiling_float_int(par1 - 3.0F - var31);
