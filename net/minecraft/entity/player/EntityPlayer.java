...
public abstract class EntityPlayer extends EntityLivingBase implements ICommandSender
{
    ...
    public void onUpdate() {
   	 ...
   	 ItemStack chestplate = this.inventory.armorItemInSlot(2);
   	 ItemStack leggings = this.inventory.armorItemInSlot(1);
   	 ItemStack boots = this.inventory.armorItemInSlot(0);
   	 ItemStack hand = this.inventory.getCurrentItem();
   	 
   	 	if(helmet != null && helmet.getItem().equals(Items.legendary_helmet)) {
   	 	this.addPotionEffect(new PotionEffect(Potion.nightVision.id, 30, 0));
   	 	}
   	 	
   	    if(chestplate != null && chestplate.getItem().equals(Items.legendary_chestplate)) {
   	 	this.addPotionEffect(new PotionEffect(Potion.damageBoost.id, 30, 0));
   	 	this.addPotionEffect(new PotionEffect(Potion.digSpeed.id, 30, 0));
   	 	}
   	    if(leggings != null && leggings.getItem().equals(Items.legendary_leggings)) {
   	 	this.addPotionEffect(new PotionEffect(Potion.moveSpeed.id, 30, 1));
   	 	}
   	    
   	 	if(boots != null && boots.getItem().equals(Items.legendary_boots)) {
   	 	this.addPotionEffect(new PotionEffect(Potion.featherfalling.id, 30, 1));
   	 	}
    ...
    public IIcon getItemIcon(ItemStack par1ItemStack, int par2)
    {
        ...
        else
        {
            ...
            {
                ItemBow bow = (ItemBow)par1ItemStack.getItem();
