...
public class ItemArmor extends Item
{
    ...
    public static enum ArmorMaterial {
        ...
        DIAMOND("DIAMOND", 4, 52, new int[]{3,7,5,3}, 10),
        
        /**
         * Minerais : Opale, Hydralite, Boxyte, Phenix, Legendaire
         */
        
        OPALE("OPALE", 5, 60, new int[]{3,7,5,4}, 10),
        HYDRALITE("HYDRALITE", 6, 70, new int[]{5,7,6,5}, 10),
        BOXYTE("BOXYTE", 7, 76, new int[]{5,7,6,5}, 10),
        PHENIX("PHENIX", 8, 84, new int[]{5,8,6,5}, 10),
        LEGENDARY("LEGENDARY", 9, 94, new int[]{5,8,8,5}, 10);
    	
        private int maxDamageFactor;
        private int[] damageReductionAmountArray;
        private int enchantability;

        private static final ItemArmor.ArmorMaterial[] $VALUES = new ItemArmor.ArmorMaterial[]{CLOTH, CHAIN, IRON, GOLD, DIAMOND, OPALE, HYDRALITE, BOXYTE, PHENIX, LEGENDARY};
