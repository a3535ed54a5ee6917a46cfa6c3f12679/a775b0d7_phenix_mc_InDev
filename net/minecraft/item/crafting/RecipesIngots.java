...
public class RecipesIngots
{
    ...
    public RecipesIngots()
    {
        this.recipeItems = new Object[][] {{Blocks.gold_block, new ItemStack(Items.gold_ingot, 9)}, 
        		...
        		{Blocks.opale_block, new ItemStack(Items.opale, 9)}, 
        		{Blocks.hydralite_block, new ItemStack(Items.hydralite, 9)}, 
        		{Blocks.boxyte_block, new ItemStack(Items.boxyte, 9)}, 
        		{Blocks.phenix_block, new ItemStack(Items.phenix, 9)}, 
        		{Blocks.legendary_block, new ItemStack(Items.legendary, 9)}
