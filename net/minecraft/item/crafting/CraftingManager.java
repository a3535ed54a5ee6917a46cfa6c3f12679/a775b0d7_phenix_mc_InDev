...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
         ...
         * Legendaire
         */
        this.addRecipe(new ItemStack(Items.legendary_refined, 1), new Object[] {"FFF", "FGF", "FFF", 'F', Items.phenix, 'G', Items.legendary}); 
        
        this.addRecipe(new ItemStack(Items.legendary_helmet, 1), new Object[] {"XGX", "X X", 'X', Items.phenix, 'G', Items.legendary_refined}); 
        this.addRecipe(new ItemStack(Items.legendary_chestplate, 1), new Object[] {"X X", "XGX", "XXX", 'X', Items.phenix, 'G', Items.legendary_refined}); 
        this.addRecipe(new ItemStack(Items.legendary_leggings, 1), new Object[] {"XGX", "X X", "X X", 'X', Items.phenix, 'G', Items.legendary_refined}); 
        this.addRecipe(new ItemStack(Items.legendary_boots, 1), new Object[] {"X X", "XGX", 'X', Items.phenix, 'G', Items.legendary_refined}); 

        this.addRecipe(new ItemStack(Items.legendary_sword, 1), new Object[] {"G", "G", "S", 'S', Items.phenix_stick, 'G', Items.legendary_refined}); 
        this.addRecipe(new ItemStack(Items.legendary_pickaxe, 1), new Object[] {"GGG", " S ", " S ", 'S', Items.phenix_stick, 'G', Items.legendary_refined}); 
        this.addRecipe(new ItemStack(Items.legendary_shovel, 1), new Object[] {"G", "S", "S", 'S', Items.phenix_stick, 'G', Items.legendary_refined}); 
        this.addRecipe(new ItemStack(Items.legendary_axe, 1), new Object[] {"GG", "GS", " S", 'S', Items.phenix_stick, 'G', Items.legendary_refined}); 
        this.addRecipe(new ItemStack(Items.legendary_hoe, 1), new Object[] {"GG", " S", " S", 'S', Items.phenix_stick, 'G', Items.legendary_refined}); 
        
        /**
         * Autres
         */
        this.addRecipe(new ItemStack(Items.diamond_string, 8), new Object[] {"SSS", "SDS", "SSS", 'S', Items.string, 'D', Items.diamond}); 
        this.addRecipe(new ItemStack(Items.hamburger, 1), new Object[] {" B ", " X ", " B ", 'B', Items.bread, 'X', Items.cooked_beef});
        this.addRecipe(new ItemStack(Items.phenix_stick, 2), new Object[] {"#", "#", '#', Items.phenix});
        
        this.addRecipe(new ItemStack(Blocks.renforced_obsidian, 1), new Object[] {"CCC", "COC", "CCC", 'C', Blocks.cobblestone, 'O', Blocks.obsidian});
