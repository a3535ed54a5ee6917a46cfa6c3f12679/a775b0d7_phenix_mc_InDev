...
public class Item
{
    ...
    public static void registerItems()
    {
        ...
        itemRegistry.addObject(261, "bow", (new ItemBow()).setMaxDamage(384).setUnlocalizedName("bow").setTextureName("bow"));
        ...
        /**
         * Minerais : Opale, Hydralite, Boxyte, Phenix, Legendaire
         */
        
        /**
         * Opale
         */
        itemRegistry.addObject(600, "opale", (new Item()).setUnlocalizedName("opale").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("opale"));
        itemRegistry.addObject(601, "opale_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.OPALE, 5, 0)).setUnlocalizedName("opale_helmet").setTextureName("opale_helmet"));
        itemRegistry.addObject(602, "opale_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.OPALE, 5, 1)).setUnlocalizedName("opale_chestplate").setTextureName("opale_chestplate"));
        itemRegistry.addObject(603, "opale_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.OPALE, 5, 2)).setUnlocalizedName("opale_leggings").setTextureName("opale_leggings"));
        itemRegistry.addObject(604, "opale_boots", (new ItemArmor(ItemArmor.ArmorMaterial.OPALE, 5, 3)).setUnlocalizedName("opale_boots").setTextureName("opale_boots"));
        itemRegistry.addObject(605, "opale_sword", (new ItemSword(Item.ToolMaterial.OPALE)).setUnlocalizedName("opale_sword").setTextureName("opale_sword"));
        itemRegistry.addObject(606, "opale_shovel", (new ItemSpade(Item.ToolMaterial.OPALE)).setUnlocalizedName("opale_shovel").setTextureName("opale_shovel"));
        itemRegistry.addObject(607, "opale_pickaxe", (new ItemPickaxe(Item.ToolMaterial.OPALE)).setUnlocalizedName("opale_pickaxe").setTextureName("opale_pickaxe"));
        itemRegistry.addObject(608, "opale_axe", (new ItemAxe(Item.ToolMaterial.OPALE)).setUnlocalizedName("opale_axe").setTextureName("opale_axe"));
        itemRegistry.addObject(609, "opale_hoe", (new ItemHoe(Item.ToolMaterial.OPALE)).setUnlocalizedName("opale_hoe").setTextureName("opale_hoe"));
        
        /**
         * Hydralite
         */
        itemRegistry.addObject(610, "hydralite", (new Item()).setUnlocalizedName("hydralite").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("hydralite"));
        itemRegistry.addObject(611, "hydralite_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.HYDRALITE, 6, 0)).setUnlocalizedName("hydralite_helmet").setTextureName("hydralite_helmet"));
        itemRegistry.addObject(612, "hydralite_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.HYDRALITE, 6, 1)).setUnlocalizedName("hydralite_chestplate").setTextureName("hydralite_chestplate"));
        itemRegistry.addObject(613, "hydralite_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.HYDRALITE, 6, 2)).setUnlocalizedName("hydralite_leggings").setTextureName("hydralite_leggings"));
        itemRegistry.addObject(614, "hydralite_boots", (new ItemArmor(ItemArmor.ArmorMaterial.HYDRALITE, 6, 3)).setUnlocalizedName("hydralite_boots").setTextureName("hydralite_boots"));
        itemRegistry.addObject(615, "hydralite_sword", (new ItemSword(Item.ToolMaterial.HYDRALITE)).setUnlocalizedName("hydralite_sword").setTextureName("hydralite_sword"));
        itemRegistry.addObject(616, "hydralite_shovel", (new ItemSpade(Item.ToolMaterial.HYDRALITE)).setUnlocalizedName("hydralite_shovel").setTextureName("hydralite_shovel"));
        itemRegistry.addObject(617, "hydralite_pickaxe", (new ItemPickaxe(Item.ToolMaterial.HYDRALITE)).setUnlocalizedName("hydralite_pickaxe").setTextureName("hydralite_pickaxe"));
        itemRegistry.addObject(618, "hydralite_axe", (new ItemAxe(Item.ToolMaterial.HYDRALITE)).setUnlocalizedName("hydralite_axe").setTextureName("hydralite_axe"));
        itemRegistry.addObject(619, "hydralite_hoe", (new ItemHoe(Item.ToolMaterial.HYDRALITE)).setUnlocalizedName("hydralite_hoe").setTextureName("hydralite_hoe"));
        
        /**
         * Boxyte
         */
        itemRegistry.addObject(620, "boxyte", (new Item()).setUnlocalizedName("boxyte").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("boxyte"));
        itemRegistry.addObject(621, "boxyte_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.BOXYTE, 7, 0)).setUnlocalizedName("boxyte_helmet").setTextureName("boxyte_helmet"));
        itemRegistry.addObject(622, "boxyte_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.BOXYTE, 7, 1)).setUnlocalizedName("boxyte_chestplate").setTextureName("boxyte_chestplate"));
        itemRegistry.addObject(623, "boxyte_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.BOXYTE, 7, 2)).setUnlocalizedName("boxyte_leggings").setTextureName("boxyte_leggings"));
        itemRegistry.addObject(624, "boxyte_boots", (new ItemArmor(ItemArmor.ArmorMaterial.BOXYTE, 7, 3)).setUnlocalizedName("boxyte_boots").setTextureName("boxyte_boots"));
        itemRegistry.addObject(625, "boxyte_sword", (new ItemSword(Item.ToolMaterial.BOXYTE)).setUnlocalizedName("boxyte_sword").setTextureName("boxyte_sword"));
        itemRegistry.addObject(626, "boxyte_shovel", (new ItemSpade(Item.ToolMaterial.BOXYTE)).setUnlocalizedName("boxyte_shovel").setTextureName("boxyte_shovel"));
        itemRegistry.addObject(627, "boxyte_pickaxe", (new ItemPickaxe(Item.ToolMaterial.BOXYTE)).setUnlocalizedName("boxyte_pickaxe").setTextureName("boxyte_pickaxe"));
        itemRegistry.addObject(628, "boxyte_axe", (new ItemAxe(Item.ToolMaterial.BOXYTE)).setUnlocalizedName("boxyte_axe").setTextureName("boxyte_axe"));
        itemRegistry.addObject(629, "boxyte_hoe", (new ItemHoe(Item.ToolMaterial.BOXYTE)).setUnlocalizedName("boxyte_hoe").setTextureName("boxyte_hoe"));
        
        /**
         * Phenix
         */
        itemRegistry.addObject(630, "phenix", (new Item()).setUnlocalizedName("phenix").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("phenix"));
        itemRegistry.addObject(631, "phenix_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.PHENIX, 8, 0)).setUnlocalizedName("phenix_helmet").setTextureName("phenix_helmet"));
        itemRegistry.addObject(632, "phenix_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.PHENIX, 8, 1)).setUnlocalizedName("phenix_chestplate").setTextureName("phenix_chestplate"));
        itemRegistry.addObject(633, "phenix_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.PHENIX, 8, 2)).setUnlocalizedName("phenix_leggings").setTextureName("phenix_leggings"));
        itemRegistry.addObject(634, "phenix_boots", (new ItemArmor(ItemArmor.ArmorMaterial.PHENIX, 8, 3)).setUnlocalizedName("phenix_boots").setTextureName("phenix_boots"));
        itemRegistry.addObject(635, "phenix_sword", (new ItemSword(Item.ToolMaterial.PHENIX)).setUnlocalizedName("phenix_sword").setTextureName("phenix_sword"));
        itemRegistry.addObject(636, "phenix_shovel", (new ItemSpade(Item.ToolMaterial.PHENIX)).setUnlocalizedName("phenix_shovel").setTextureName("phenix_shovel"));
        itemRegistry.addObject(637, "phenix_pickaxe", (new ItemPickaxe(Item.ToolMaterial.PHENIX)).setUnlocalizedName("phenix_pickaxe").setTextureName("phenix_pickaxe"));
        itemRegistry.addObject(638, "phenix_axe", (new ItemAxe(Item.ToolMaterial.PHENIX)).setUnlocalizedName("phenix_axe").setTextureName("phenix_axe"));
        itemRegistry.addObject(639, "phenix_hoe", (new ItemHoe(Item.ToolMaterial.PHENIX)).setUnlocalizedName("phenix_hoe").setTextureName("phenix_hoe"));
        
        /**
         * Legendaire
         */
        itemRegistry.addObject(640, "legendary", (new Item()).setUnlocalizedName("legendary").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("legendary"));
        itemRegistry.addObject(641, "legendary_refined", (new ItemSimpleFoiled()).setUnlocalizedName("legendary_refined").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("legendary_refined"));
        itemRegistry.addObject(642, "legendary_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.LEGENDARY, 9, 0)).setUnlocalizedName("legendary_helmet").setTextureName("legendary_helmet"));
        itemRegistry.addObject(643, "legendary_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.LEGENDARY, 9, 1)).setUnlocalizedName("legendary_chestplate").setTextureName("legendary_chestplate"));
        itemRegistry.addObject(644, "legendary_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.LEGENDARY, 9, 2)).setUnlocalizedName("legendary_leggings").setTextureName("legendary_leggings"));
        itemRegistry.addObject(645, "legendary_boots", (new ItemArmor(ItemArmor.ArmorMaterial.LEGENDARY, 9, 3)).setUnlocalizedName("legendary_boots").setTextureName("legendary_boots"));
        itemRegistry.addObject(646, "legendary_sword", (new ItemSword(Item.ToolMaterial.LEGENDARY)).setUnlocalizedName("legendary_sword").setTextureName("legendary_sword"));
        itemRegistry.addObject(647, "legendary_shovel", (new ItemSpade(Item.ToolMaterial.LEGENDARY)).setUnlocalizedName("legendary_shovel").setTextureName("legendary_shovel"));
        itemRegistry.addObject(648, "legendary_pickaxe", (new ItemPickaxe(Item.ToolMaterial.LEGENDARY)).setUnlocalizedName("legendary_pickaxe").setTextureName("legendary_pickaxe"));
        itemRegistry.addObject(649, "legendary_axe", (new ItemAxe(Item.ToolMaterial.LEGENDARY)).setUnlocalizedName("legendary_axe").setTextureName("legendary_axe"));
        itemRegistry.addObject(650, "legendary_hoe", (new ItemHoe(Item.ToolMaterial.LEGENDARY)).setUnlocalizedName("legendary_hoe").setTextureName("legendary_hoe"));
        
        /**
         * Arcs
         */
        itemRegistry.addObject(651, "opale_bow", (new ItemBow()).setMaxDamage(500).setUnlocalizedName("opale_bow").setTextureName("opale_bow"));
        itemRegistry.addObject(652, "hydralite_bow", (new ItemBow()).setMaxDamage(600).setUnlocalizedName("hydralite_bow").setTextureName("hydralite_bow"));
        itemRegistry.addObject(653, "boxyte_bow", (new ItemBow()).setMaxDamage(700).setUnlocalizedName("boxyte_bow").setTextureName("boxyte_bow"));
        itemRegistry.addObject(654, "phenix_bow", (new ItemBow()).setMaxDamage(800).setUnlocalizedName("phenix_bow").setTextureName("phenix_bow"));
        itemRegistry.addObject(655, "legendary_bow", (new ItemBow()).setMaxDamage(900).setUnlocalizedName("legendary_bow").setTextureName("legendary_bow"));
        
        /**
         * Autres
         */
        itemRegistry.addObject(656, "spawner_pickaxe", (new ItemPickaxe(Item.ToolMaterial.SPAWNER)).setUnlocalizedName("spawner_pickaxe").setTextureName("spawner_pickaxe"));
        itemRegistry.addObject(657, "obsidian_pickaxe", (new ItemPickaxe(Item.ToolMaterial.OBSIDIAN)).setUnlocalizedName("obsidian_pickaxe").setTextureName("obsidian_pickaxe"));
        itemRegistry.addObject(658, "hamburger", (new ItemHamburger(6, 1.2F, false)).setAlwaysEdible().setUnlocalizedName("hamburger").setTextureName("hamburger"));    
        itemRegistry.addObject(659, "phenix_stick", (new Item()).setUnlocalizedName("phenix_stick").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("phenix_stick"));
        itemRegistry.addObject(660, "diamond_string", (new Item()).setUnlocalizedName("diamond_string").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("diamond_string"));
            
        itemRegistry.addObject(661, "opale_key", (new ItemSimpleFoiled()).setUnlocalizedName("opale_key").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("opale_key"));
        itemRegistry.addObject(662, "hydralite_key", (new ItemSimpleFoiled()).setUnlocalizedName("hydralite_key").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("hydralite_key"));
        itemRegistry.addObject(663, "boxyte_key", (new ItemSimpleFoiled()).setUnlocalizedName("boxyte_key").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("boxyte_key"));
        itemRegistry.addObject(664, "phenix_key", (new ItemSimpleFoiled()).setUnlocalizedName("phenix_key").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("phenix_key"));
        
        itemRegistry.addObject(665, "cendres", (new Item()).setUnlocalizedName("cendres").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("cendres"));
        itemRegistry.addObject(666, "ash", (new Item()).setUnlocalizedName("ash").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("ash"));
 ...
 public static enum ToolMaterial {
         ...
         */
	 	...
	 	OPALE("OPALE", 5, 3, 1800, 8.0F, 4.0F, 10),
	 	HYDRALITE("HYDRALITE", 6, 3, 2000, 8.0F, 5.0F, 10),
	 	BOXYTE("BOXYTE", 7, 3, 2300, 8.0F, 6.0F, 10),
	 	PHENIX("PHENIX", 8, 3, 2500, 8.0F, 7.0F, 10),
	 	LEGENDARY("LEGENDARY", 9, 3, 2800, 8.0F, 8.0F, 10),
	 	
	 	SPAWNER("SPAWNER", 10, 3, 2, 8.0F, 7.5F, 10),
	 	OBSIDIAN("OBSIDIAN", 11, 3, 300, 60.0F, 7.5F, 10);
        ...
        private static final Item.ToolMaterial[] $VALUES = new Item.ToolMaterial[]{WOOD, STONE, IRON, EMERALD, GOLD, OPALE, HYDRALITE, HYDRALITE, PHENIX, LEGENDARY, SPAWNER, OBSIDIAN};
            			...
            			(this == IRON ? Items.iron_ingot : 
            				(this == EMERALD ? Items.diamond : 
            					...
            					(this == OPALE ? Items.opale :
            						(this == HYDRALITE ? Items.hydralite :
            							(this == BOXYTE ? Items.boxyte :
            								(this == PHENIX ? Items.phenix :
            									(this == LEGENDARY ? Items.legendary_refined :
            					null)))))))));
        }
    }
}
